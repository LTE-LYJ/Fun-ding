...
public class Project {
	...
	public static Project fromResultSet(ResultSet resultSet) throws SQLException {
		Project p = new Project();
		p.setPrjNo(resultSet.getInt("PRJ_NO"));
		p.setPrjTitle(resultSet.getString("PRJ_TITLE"));
		p.setCreName(resultSet.getString("MEM_NAME"));
		p.setPrjCatName(resultSet.getString("PRJ_CAT_NAME"));
		p.setPrjTarget(resultSet.getDouble("PRJ_TARGET"));
		p.setPrjCurrent(resultSet.getDouble("PRJ_CURRENT"));
		p.setPrjStartDate(resultSet.getString("PRJ_STARTDATE"));
		p.setPrjEndDate(resultSet.getString("PRJ_ENDDATE"));
		p.setAttachmentName(resultSet.getString("CHANGE_NAME"));
		return p;
	}
}
