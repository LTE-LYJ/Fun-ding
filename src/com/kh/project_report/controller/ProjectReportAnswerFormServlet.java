...
/**
 * Servlet implementation class ProjectReportAnswerFormServlet
 */
@WebServlet("/views/project_report/projectReportAnswer")
public class ProjectReportAnswerFormServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ProjectReportAnswerFormServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (prjReport != null) {
			...
			view = "/views/project_report/projectReportAnswer.jsp";
		} 
