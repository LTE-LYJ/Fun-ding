...
public class BoardDao {
	...
	public List<Board> getBoardList(Connection con, String field, String query, int page) {
		...
		String sql = "SELECT * FROM( "
				...
				+ "                FROM BOARD A"
				+ "                INNER JOIN MEMBER B ON MEM_NO = BOARD_WRITER "
		...
		try {
			...
			while (rs.next()) {
				...
				int boardType = rs.getInt("CATEGORY_NO");
				int categoryNo = rs.getInt("CATEGORY_NO");
				int boardWriter = rs.getInt("BOARD_WRITER");
