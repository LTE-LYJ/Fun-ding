		...
		<section class="panel important">
			...
			<form id="insertForm" action="updatePlan.pr" method="post">
				<div class="twothirds">
					...
					창작자 이름:<br>
					<input type="text" name="cname" id="cname" size="40" placeholder="이름을 입력해주세요." value="<%= creator.getCreName() %>"/><br>
					창작자 소개:<br>
					<textarea name="ccontent" id="ccontent" rows="15" cols="67" placeholder="창작자님의 이력과 소개를 써주세요."><%= creator.getCreContent() %></textarea><br>
					<br>
