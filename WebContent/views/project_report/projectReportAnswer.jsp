...
<body>
	...
	<c:set var="contextPath" value="<%=request.getContextPath() %>"></c:set>
		<form method="post" action="${contextPath}/pAnswer.pr?prjReportNo=${pr.prjReportNo}" enctype="multipart/form-data">
				...
				<div class="board_write">
					<div class="btitle">
						<dl>
							<dt>제목</dt>
							<dd>
								<input id="title" type="text" name="title"  value="${pr.prjReportTitle }" readonly/>
							</dd>
						</dl>
					</div>
					...
					<div class="btitle" >
						<dl>
							<dt>프로젝트번호</dt>
							<dd>
								<input type="text" name="prjNo" value="${pr.prjNo}" readonly/>
							</dd>
						</dl>
					</div>
