 ...
 * Generated at: 2021-08-26 06:47:33 UTC
...
import com.kh.project_detail.controller.projectDetailAskPageServlet;
...
public final class projectDetailInfo_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("com.kh.project_detail.controller.projectDetailAskPageServlet");
...
if(at == null){ 
      ...
      try {
        ...
        // /views/project_detail/projectDetailInfo.jsp(36,114) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_fmt_005fformatNumber_005f0.setValue(project.getPrjCurrent());
        // /views/project_detail/projectDetailInfo.jsp(36,114) name = groupingUsed type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      try {
        ...
        // /views/project_detail/projectDetailInfo.jsp(39,98) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_fmt_005fformatNumber_005f1.setValue((float)project.getPrjCurrent()/project.getPrjTarget());
        // /views/project_detail/projectDetailInfo.jsp(39,98) name = type type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      try {
        ...
        // /views/project_detail/projectDetailInfo.jsp(42,61) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_fmt_005fformatDate_005f0.setValue(sdFormat.parse(project.getPrjStartDate()));
        // /views/project_detail/projectDetailInfo.jsp(42,61) name = type type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_fmt_005fformatDate_005f0.setType("date");
        // /views/project_detail/projectDetailInfo.jsp(42,61) name = pattern type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
 ...
 if((date.getTime()<sdFormat.parse(project.getPrjEndDate()).getTime())){
      ...
      try {
        ...
        // /views/project_detail/projectDetailInfo.jsp(49,62) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_fmt_005fformatDate_005f1.setValue(sdFormat.parse(project.getPrjEndDate()));
        // /views/project_detail/projectDetailInfo.jsp(49,62) name = type type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_fmt_005fformatDate_005f1.setType("date");
        // /views/project_detail/projectDetailInfo.jsp(49,62) name = pattern type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
if(project.getStatus().equals("Y")){
      ...
      out.write("	        	            		   alert('재펀딩 요청이 완료되었습니다.');\r\n");
      ...
      out.write("	            \r\n");
      out.write("	          \r\n");
      out.write(" <!---                         프로젝트 관련 내용 sub1 부분                -->\r\n");
      out.write("	                <div id=\"body_content2\">\r\n");
      out.write("	\r\n");
      out.write("	                    <div id=\"bottom_content\">\r\n");
      out.write("	                <div id=\"bottom_left_content\" style=\"height: 100%; margin-top: 0px\">\r\n");
      out.write("	                    ");
...
for(int i =0; i<prjAttList.size();i++){ 
      out.write("\r\n");
      out.write("	                   	<img src=\"resources/upfiles_project/");
      out.print(prjAttList.get(i).getChangeName());
      out.write("\" style=\"width: 725px;\">\r\n");
      out.write("	                	");
}
      out.write("\r\n");
      out.write("	                </div>\r\n");
      out.write("	\r\n");
      out.write("	                <aside id=\"aside2\">\r\n");
      out.write("	                ");
      out.write("\r\n");
      out.write("	                ");
if(rewordList.isEmpty()){ 
 ...
 for( int i=0; i<rewordList.size();i++){ 
      ...
      out.write("\r\n");
      out.write("				\r\n");
      out.write("	                <div id=\"creator_content\">\r\n");
      out.write("	                 ");
if(at == null){ 
      out.write("\r\n");
      out.write("	                 <div><img class=\"profile\" src=\"");
      out.print(request.getContextPath());
      out.write("/resources/images/default.PNG\" style=\"width: 40px; height: 40px; border-radius: 70%; vertical-align: middle; float:none; margin-bottom:10px; clear: both;\">\r\n");
      out.write("							");
} else { 
      out.write("\r\n");
      out.write("							<div><img class=\"profile\" src=\"resources/upfiles_profile/");
      out.print(createrPro.getChangeName() );
      out.write("\" style=\"width: 40px; height: 40px; border-radius: 70%; vertical-align: middle; float:none; margin-bottom:10px; clear: both;\">\r\n");
      out.write("							");
} 
      out.write("\r\n");
      out.write("	                    <span><h4 id=\"creatorName\" style=\"display: inline-flex; margin-left: 10px; margin-top:20px\">");
      out.print(creator.getCreName() );
      out.write("</h4></span></div><br>\r\n");
      out.write("	                    <br><div>");
      out.print(creator.getCreContent() );
      out.write("</div><br><br>\r\n");
      out.write("	                    <div><h4 style=\"display: inline;\">진행한 프로젝트 : </h4> <span><h4 style=\"display: inline;\">");
      out.print(creator.getPrjCountNo() );
      out.write("</h4></span></div>\r\n");
      out.write("	                </div>\r\n");
      out.write("	            </aside>\r\n");
      out.write("	        </div>\r\n");
      out.write("	\r\n");
      ...
      out.write("			    \r\n");
      out.write("	    <script>\r\n");
      out.write("	    $('#proInfo').css('color','black');\r\n");
      ...
      out.write("	                $(\"input[type='radio']\").prop('checked', true);\r\n");
