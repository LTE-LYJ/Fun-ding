 ...
 * Generated at: 2021-08-25 13:43:41 UTC
...
public final class projectDetailAsk_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("com.kh.project_detail.model.vo.PageInfo");
...
if(at == null){ 
      ...
      try {
        ...
        // /views/project_detail/projectDetailAsk.jsp(41,114) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_fmt_005fformatNumber_005f0.setValue(project.getPrjCurrent());
        // /views/project_detail/projectDetailAsk.jsp(41,114) name = groupingUsed type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      try {
        ...
        // /views/project_detail/projectDetailAsk.jsp(44,98) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_fmt_005fformatNumber_005f1.setValue((float)project.getPrjCurrent()/project.getPrjTarget());
        // /views/project_detail/projectDetailAsk.jsp(44,98) name = type type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      try {
        ...
        // /views/project_detail/projectDetailAsk.jsp(47,61) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_fmt_005fformatDate_005f0.setValue(sdFormat.parse(project.getPrjStartDate()));
        // /views/project_detail/projectDetailAsk.jsp(47,61) name = type type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_fmt_005fformatDate_005f0.setType("date");
        // /views/project_detail/projectDetailAsk.jsp(47,61) name = pattern type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
 ...
 if((date.getTime()<sdFormat.parse(project.getPrjEndDate()).getTime())){
      ...
      try {
        ...
        // /views/project_detail/projectDetailAsk.jsp(54,62) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_fmt_005fformatDate_005f1.setValue(sdFormat.parse(project.getPrjEndDate()));
        // /views/project_detail/projectDetailAsk.jsp(54,62) name = type type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_fmt_005fformatDate_005f1.setType("date");
        // /views/project_detail/projectDetailAsk.jsp(54,62) name = pattern type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
if(project.getStatus().equals("Y")){
      ...
      out.write("			<thead>\r\n");
      out.write("				<tr>\r\n");
      out.write("					<th class=\"table1\">글번호</th>\r\n");
      out.write("					<input type=\"hidden\" class=\"table6\" />\r\n");
      out.write("					<th class=\"table2\">글제목</th>\r\n");
      out.write("					<th class=\"table3\">작성자</th>\r\n");
      out.write("					<th class=\"table4\">작성일</th>\r\n");
      out.write("					<th class=\"table5\">조회수</th>\r\n");
      out.write("				</tr>\r\n");
      out.write("			<thead>\r\n");
      out.write("			<tbody>\r\n");
      out.write("               ");
 ...
 if(askList.isEmpty()){ 
      out.write("\r\n");
      out.write("				 	<tr class=\"table0\">\r\n");
      out.write("						<td colspan=\"5\" style=\"height: 40px;\">존재하는 공지사항이 없습니다.</td>\r\n");
      out.write("					</tr>\r\n");
      out.write("				 ");
 }else{  
      out.write("\r\n");
 ...
 for(ProjectAsk n : askList){ 
      ...
      out.write("				 			<td class=\"table1\">");
      out.print( n.getPrjAskNownum() );
      out.write("</td>\r\n");
      out.write("				 			<input type=\"hidden\" class=\"table6\" value=\"");
      out.print( n.getPrjAskNo() );
      out.write("\" style=\"border-left: none;\"/>\r\n");
      out.write("							<td class=\"table2\">");
      out.print( n.getPrjAskTitle() );
      out.write("</td>\r\n");
      out.write("							<td class=\"table3\">");
      out.print( n.getMemId() );
      out.write("</td>\r\n");
      out.write("							<td class=\"table4\">");
      out.print( n.getEnrollDate() );
      out.write("</td>\r\n");
      out.write("							<td class=\"table5\">");
      ...
      out.print(request.getContextPath());
      out.write("/proAsk.list?currentPage=1&num='+");
      out.print(num );
      out.write("\"> &lt;&lt; </button>\r\n");
      out.write("		\r\n");
      out.write("			<!-- 이전페이지로(<) -->\r\n");
...
if(currentPage == 1){ 
      ...
      out.write("			<button onclick=\"location.href='");
      out.print(request.getContextPath());
      out.write("/proAsk.list?currentPage=");
...
if(currentPage == maxPage){ 
      ...
      out.write("\"> &gt;&gt; </button>\r\n");
      out.write("		</div> \r\n");
      out.write("        <button type=\"button\" id=\"btn_ask\" onclick=\"wirteAsk()\">문의하기</button><br style=\"float: none;\">\r\n");
      out.write("\r\n");
      out.write("                    </div>\r\n");
      out.write("                </div>\r\n");
      out.write("            </div> \r\n");
      ...
      out.write("                    \r\n");
      out.write("         <script>\r\n");
      out.write("            function wirteAsk() {\r\n");
      out.write("            	");
if(loginUser!=null){
      out.write("\r\n");
      out.write("            	window.open(\"views/project_detail/projectDetailAskNewPop.jsp?num=\"+");
      out.print(num);
      out.write(", \"문의쓰기\", \"top=100px, left=300px, height=430px, width=600px, resizable=no\");\r\n");
      out.write("            	\r\n");
      out.write("    			");
}else{
      out.write("\r\n");
      ...
      out.write("\r\n");
      out.write("			}\r\n");
      out.write("            $('#proAsk').css('color','black');\r\n");
...
if(!askList.isEmpty()){
      ...
      out.write("            	  var askNum = $(this).children().eq(1).val();\r\n");
      out.write("            	  alert(askNum)\r\n");
      out.write("            	  ");
if(loginUser!=null){
      out.write("\r\n");
      out.write("                  	window.open(\"");
      out.print(request.getContextPath());
      out.write("/detail.prjPop?askNum=\"+askNum +\"&num=\"+");
      out.print(num);
      out.write(", \"문의쓰기\", \"top=100px, left=300px, height=430px, width=600px, resizable=no\");\r\n");
